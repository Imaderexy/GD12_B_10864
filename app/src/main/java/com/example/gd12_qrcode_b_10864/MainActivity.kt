package com.example.gd12_qrcode_b_10864
...
import com.example.gd12_qrcode_b_10864.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity(), View.OnClickListener {
    ...
    private fun checkCameraPermissions(): Boolean {
        val resultcamera = checkSelfPermission(Manifest.permission.CAMERA) == (PackageManager.PERMISSION_GRANTED)
        val resultstorage = checkSelfPermission(Manifest.permission.WRITE_EXTERNAL_STORAGE) == (PackageManager.PERMISSION_GRANTED)
