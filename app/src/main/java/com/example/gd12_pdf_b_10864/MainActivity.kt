package com.example.gd12_pdf_b_10864
...
import com.example.gd12_pdf_b_10864.R
import com.example.gd12_pdf_b_10864.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    private fun createPdf(nama: String, umur: String, tlp: String, alamat: String, kampus: String) {
        ...
        val file = File(pdfPath, "pdf_10864.pdf")
